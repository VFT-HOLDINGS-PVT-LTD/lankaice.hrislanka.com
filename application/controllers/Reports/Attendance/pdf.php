...
//         $sheet->setCellValue('C1','FDate');
//         $sheet->setCellValue('D1','ShiftDay');
//         $sheet->setCellValue('E1','ShType');
//         $sheet->setCellValue('F1','FTime');
...
//             $sheet->setCellValue('D'.$x, $row['ShiftDay']);
//             $sheet->setCellValue('E'.$x, $row['ShType']);
//             $sheet->setCellValue('F'.$x, $row['FTime']);
//             $x++;
//         }
