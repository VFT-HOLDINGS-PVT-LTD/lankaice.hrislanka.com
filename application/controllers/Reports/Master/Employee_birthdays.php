...
class Employee_birthdays extends CI_Controller {
    ...
    public function Report_DOB() {
        ...
        $Data['data_set'] = $this->Db_model->getfilteredData("select EmpNo,Emp_Full_Name,DOB,B_name from tbl_empmaster INNER JOIN tbl_branches ON tbl_empmaster.B_id = tbl_branches.B_id ORDER BY MONTH(DOB) ASC, DAY(DOB) ASC");
