...
<head>
    ...
    <style>
        ...
        #attendance-message span {
            ...
            animation: fadeInOut 2s ease-in-out infinite, colorPulse 4s ease-in-out infinite;
        }
    </style>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="panel panel-info">
                                                        <div class="panel-heading">
                                                            <h2>ATTENDANCE INITIALIZE</h2>
                                                        </div>
                                                        <div class="panel-body">
                                                            <form class="form-horizontal" id="frm_shift_allocation"
                                                                name="frm_shift_allocation"
                                                                action="<?php echo base_url(); ?>Attendance/Attendance_Initialize/initialize"
                                                                method="POST">
                                                                ...
                                                                <div class="form-group col-sm-12">
                                                                    <div class="col-sm-8">
                                                                        <img class="imagecss"
                                                                            src="<?php echo base_url(); ?>assets/images/process_remove.png">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    <div class="form-group col-sm-6">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <select class="form-control" id="cmb_cat"
                                                                                name="cmb_cat" onchange="selctcity()">
                                                                ...
                                                                if ($autorun_settings[0]->status_flag == 1) {
                                                                    ...
                                                                    <div id="attendance-message">
                                                                        <span style="color: red;">Now Attendance Process is Running. Please Try Again Later.</span>
                                                                    </div>
                                                                    <?php
                                                                    ...
                                                                    <!--end submit-->
                                                                    <?php
                                                                } elseif ($autorun_settings3[0]->status_flag == 1) {
                                                                    ?>
                                                                    <div id="attendance-message">
                                                                    <span style="color: red;">Now Attendance Initialize is Running. Please Try Again
                                                                        Later.</span>
                                                                    </div>
                                                                    <?php
                                                                } elseif ($autorun_settings2[0]->status_flag == 1) {
                                                                    ?>
                                                                    <div id="attendance-message">
                                                                    <span style="color: red;">Now Shift Allocation is Running. Please Try Again
                                                                        Later. </span>
                                                                    </div>
                                                                    <?php
                                                                }
                ...
                if (selectedValue === 'Employee') {
                    dynamicFields.html(`
                        <div class="form-group col-sm-6">
                            ...
                            <div class="col-sm-8">
                                <select type="text"  autocomplete="off" class="form-control txt_nic itemName" name="txt_nic" id="txt_nic" placeholder="">
                                </select>
                            </div>
                        </div>
                        <div class="form-group col-sm-6">
                    ...
                    dynamicFields.html(`
                        <div class="form-group col-sm-6">
                            ...
                            <div class="col-sm-8" id="cat_div">
                                <select class="form-control"  id="cmb_cat2" name="cmb_cat2">
                                </select>
                            </div>
                        </div>
                    `);
