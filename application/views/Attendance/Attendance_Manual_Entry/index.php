                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="panel panel-info">
                                                            ...
                                                            <div class="panel-body">
                                                                <form class="form-horizontal" id="frm_employee_view" name="frm_employee_view" action="<?php echo base_url(); ?>Attendance/Attendance_Manual_Entry/emp_manual_entry" method="POST">
