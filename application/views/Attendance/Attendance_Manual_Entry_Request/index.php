                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="panel panel-info">
                                                            ...
                                                            <div class="panel-body">
                                                                <form class="form-horizontal" id="frm_employee_view" name="frm_employee_view" action="<?php echo base_url(); ?>Attendance/Attendance_Manual_Entry_Request/emp_manual_entry" method="POST">
                                                                    ...
                                                                    <div class="from-group col-md-12">
                                                                        <div class="form-group col-sm-3">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <input type="text" class="form-control" required="" name="att_date" id="att_date" placeholder="Ex: Select Date">
                                                                            </div>
                                                                        ...
                                                                        <div class="form-group col-sm-3">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <input type=time class="form-control" required="" name="in_time" id="in_time" placeholder="Ex: Select Date">
                                                                            </div>

                                                                        </div>
                                                                        <!-- <div class="form-group col-sm-3">
                                                                            <label for="focusedinput" class="col-sm-4 control-label">Out Time</label>
                                                                            <div class="col-sm-8">
                                                                                <input type="time" class="form-control" required="" name="out_time" id="out_time" placeholder="Ex: Select Date">
                                                                            </div>
