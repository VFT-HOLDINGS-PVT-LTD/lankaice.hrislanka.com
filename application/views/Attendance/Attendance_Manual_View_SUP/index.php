                                                            ...
                                                            <div class="panel-body">
                                                                <form class="form-horizontal" id="frm_leave_request" name="frm_leave_request" action="" method="POST">
                                                                    ...
                                                                    <label for="focusedinput"
                                                                        class="col-sm-4 control-label">Region<span
...
//                            $('#cmb_cat2').remove();
        ...
        <script>
            ...
            $("#search").click(function () {
                ...
                $('#search_body').load("<?php echo base_url(); ?>Attendance/Attendance_Manual_Entry_SAPP/search_employee", {'txt_emp': $('#txt_emp').val(), 'txt_emp_name': $('#txt_emp_name').val(), 'cmb_desig': $('#cmb_desig').val(), 'cmb_dep': $('#cmb_dep').val(), 'txt_nic': $('#txt_nic').val(), 'cmb_status': $('#cmb_status').val(), 'cmb_gender': $('#cmb_gender').val(),'txt_from_date': $('#dpd1').val(),'txt_to_date': $('#dpd2').val(), 'cmb_branch': $('#cmb_branch').val()});
            });
