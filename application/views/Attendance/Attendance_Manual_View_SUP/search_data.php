            ...
            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <?php foreach ($data_set as $data) {?>
                        <tr class='odd gradeX'>
                            ...
                            <td width='15'><a class='get_data btn btn-primary' href="<?php echo base_url() . 'Attendance/Attendance_Manual_Entry_SAPP/approve/' . $data->M_ID; ?>">APPROVE<i class=''></i></a></td>
                            <td width='15'><a class='get_data btn btn-danger' href="<?php echo base_url() . 'Attendance/Attendance_Manual_Entry_SAPP/ajax_StatusReject/' . $data->M_ID; ?>">REJECT<i class=''></i></a></td>
                        </tr>
                    <?php }?>
                </tbody>
            </table>
