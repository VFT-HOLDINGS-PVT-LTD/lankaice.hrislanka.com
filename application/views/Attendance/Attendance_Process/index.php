                                                        ...
                                                        <div class="panel-body">
                                                            <form
                                                                ...
                                                                <?php if (count($sh_employees) > 0) { ?>
                                                                    <h3 style="color: #000">* Please Allocate Shift for
                                                                        following employees for First Time </h3>
                                                                ...
                                                                <div class="form-group col-sm-12">
                                                                    <div class="col-sm-8">
                                                                        <img class=""
                                                                            ...
                                                                            src="<?php echo base_url(); ?>assets/images/process_attendance.png">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    if ($autorun_settings[0]->status_flag == 1) {
                                                                        ...
                                                                        <div id="alert-container">
                                                                            <div class="alert alert-danger" role="alert"
                                                                                ...
                                                                                Now Attendance Process is Running. Please Try
                                                                                Again Later.
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div id="alert-container">
                                                                            <div class="alert alert-danger" role="alert"
                                                                                style="margin-top: 30px;">
                                                                                Now Attendance Initialize is Running. Please Try
                                                                                Again Later. </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div id="alert-container">
                                                                        <div class="alert alert-danger" role="alert"
                                                                            style="margin-top: 30px;">
                                                                            Now Shift Allocation is Running. Please Try
                                                                            Again Later. </div>
                                                                    </div>
                                                            </div>
                                                            <?php
