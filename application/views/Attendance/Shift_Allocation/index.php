                                                        ...
                                                        <div class="panel-body">
                                                            <form class="form-horizontal" id="frm_shift_allocation"
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <div class="form-group col-sm-6">
                                                                        <label for="focusedinput"
                                                                            class="col-sm-4 control-label">Weekly
                                                                            Roster</label>
                                                                        <div class="col-sm-8">
                                                                            <select class="form-control" id="cmb_roster"
                                                                                name="cmb_roster">
                                                            ...
                                                            ?>
                                                            <div id="attendance-message">
                                                                <span style="color: red;">Now Attendance Initialize is Running. Please Try Again Later.</span>
                                                            </div>
                                                            <?php
                                                                } elseif ($autorun_settings2[0]->status_flag == 1) {
                                                            ?>
                                                            <div id="attendance-message">
                                                                <span style="color: red;">Now Shift Allocation is Running. Please Try Again Later. </span>
                                                            </div>
                                                            <?php
                                                                }
                                                            ?>
