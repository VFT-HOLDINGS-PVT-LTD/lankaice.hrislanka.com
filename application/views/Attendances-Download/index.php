  ...
  <script>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const devSNToName = {
                "GED7234201245": "NuwaraEliya",
                "GED7234201231": "Colombo",
                "GED7240200040": "Rathnapura",
                "GED7240200038": "Kegalle",
                "GED7240200127": "Pallekale",
                "GED7240200121": "Galle",
                "GED7240200031": "Hatton",
                "A6F5230760029": "Badulla"
            };
            ...
            .then(data => {
                if (data.token) {
                    ...
                    .then(data => {
                        ...
                        // Loop through the data but limit to the first 30 rows
                        let rowCount = 0;
                        data.some(item => {
                            if (allowedDevSNs.includes(item.DevSN)) {
                                ...
                                // Insert each new row at the top of the table
            ...
            window.onload = function() {
                ...
                .then(data => {
                    if (data.token) {
                        ...
                        // Fetch the device data using the APIToken
                        fetch("https://biotime.cloud:8000/api/admin/device/3", {
                            method: "GET",
                            headers: {
                                "ApiToken": `${ApiToken}`,
                                "Content-Type": "application/json"
