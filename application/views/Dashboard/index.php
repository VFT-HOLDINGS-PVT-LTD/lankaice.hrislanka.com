...
?>
                                    ...
                                    <?php endif; ?>
                                        ...
                                        <?php if ($currentUser[0]->add_employee_branch == 1): ?>
                                            <div class="col-md-3">
                                                  <a style="background-color: #479cba"  class="info-tile has-footer" href="<?php echo base_url(); ?>Employee_Management/ADD_Employees_Branch">
                                                    ...
                                                    <div class="tile-footer">
                                                        <div style="color: #ffffff" class="pull-left">ADD EMPLOYEES</div>
                                    ...
                                    <?php endif; ?>
                                        ...
                                        <?php if ($currentUser[0]->payroll_process == 1): ?>
                                            <div class="col-md-3">
                                              <a style="background-color: #479cba"  class="info-tile has-footer" href="<?php echo base_url(); ?>Payroll/Payroll_Process/">
                                                    <div class="tile-heading">
                                    ...
                                    <div class="row">
                                        <?php if ($currentUser[0]->manual_att_request == 1): ?>
                                            ...
                                            <!-- <div class="col-md-3">
                                               <a style="background-color: #479cba"  class="info-tile has-footer" href="<?php echo base_url(); ?>Attendance/Attendance_Manual_Entry_Request">
                                                    <div class="tile-heading">
                                    ...
                                    <?php endif; ?>
                                        ...
                                        <?php if ($currentUser[0]->write_cheque == 1): ?>
                                            <div class="col-md-3">
                                             <a style="background-color: #479cba"  class="info-tile has-footer" href="<?php echo base_url(); ?>Cheque/Write_Cheque/">
                                                    <div class="tile-heading">
                                                        <div class="pull-left">Cheque Print</div>
                                                        <div class="pull-right">
                                                    ...
                                                    <div class="tile-footer">
                                                        <div style="color: #ffffff" class="pull-left">CHEQUE PRINT</div>
                                        ...
                                        <?php if ($currentUser[0]->request_advance == 1): ?>
                                            <div class="col-md-3">
                                                <a style="background-color: #479cba"  class="info-tile has-footer" href="<?php echo base_url(); ?>Pay/Salary_Advance_req/">
                                                    <div class="tile-heading">
                                                        <div class="pull-left">REQUEST SALARY ADVANCE</div>
                                                        <div class="pull-right">
                                                            <div id="tilemembers" class="sparkline-block"></div>
                                                        </div>
                                                    </div>
            ...
            $(function () {
                function renderChart(attended, absent, title = 'Department Attendance') {
                    Highcharts.chart('today_attendence', {
                        chart: {
                            type: 'column',
                            options3d: { enabled: true, alpha: 15, beta: 15 }
                        },
                        title: { text: title, align: 'left' },
                        plotOptions: { column: { depth: 35 } },
                        xAxis: { categories: ['Attendance', 'Absence'] },
                        yAxis: {
                            min: 0,
                ...
                $.post("<?php echo base_url('dashboard/get_attendance_data'); ?>", { department: 'all' }, function (res) {
...
<script type="text/javascript">
    $(function () {
        ...
        // Initial load (All departments)
        $.post("<?php echo base_url('dashboard/get_employee_data'); ?>", { department: 'all' }, function (res) {
    ...
    $.post("<?php echo base_url('dashboard/get_employee_data'); ?>", formData, function (res) {
        ...
        // Request notification permission from the user
            ...
            if (Notification.permission === "granted") {
                new Notification("VFT Attendance System Alert", {
                body: "The attendance process is carried out in the VFT Attendance System",
                icon: "<?php echo base_url(); ?>assets/images/company/VTF-Logo.png", // Optional: add an icon for the notification
                });
            }
            }

            // Detect when the attendance message is visible
            document.addEventListener("DOMContentLoaded", function () {
            const attendanceMessage = document.getElementById("attendance-message");

            if (attendanceMessage && window.getComputedStyle(attendanceMessage).display !== "none") {
