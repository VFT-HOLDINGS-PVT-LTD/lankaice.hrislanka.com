                                                            ...
                                                            <form class="form-horizontal" id="frm_employee"
                                                                ...
                                                                <div class="form-group col-sm-6"
                                                                    ...
                                                                    <label for="focusedinput"
                                                                        class="col-sm-4 control-label">Company Emp No
                                                                        <span style="color: red;">*</span></label>
                                                                    <div class="col-sm-8">
                                                                        <input type="text" class="form-control"
                                                                            id="companyNo" name="companyNo"
                                                                            placeholder="Company No" required="">
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <div class="form-group col-sm-6">
                                                                        <label for="focusedinput"
                                                                            class="col-sm-4 control-label">Preferred
                                                                            Name</label>
                                                                        <div class="col-sm-8">
                                                                            <input type="text" class="form-control"
                                                                                id="pNameId" name="pName"
                                                                    ...
                                                                    <div class="form-group col-sm-6">
                                                                        <label for="focusedinput"
                                                                            class="col-sm-4 control-label">Reporting
                                                                            Person</label>
                                                                        <div class="col-sm-8">
                                                                            <input type="text" class="form-control"
                                                                                id="rPersonId" name="rPerson"
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <div class="form-group col-sm-6">
                                                                        <label for="focusedinput"
                                                                            class="col-sm-4 control-label">Employee Leave
                                                                            Group <span
                                                                                style="color: red;">*</span></label>
                                                                        <div class="col-sm-8">
                                                                            <select class="form-control" required=""
                                                                    ...
                                                                    <div class="form-group col-sm-6">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <select class="form-control" required=""
                                                                                id="cmb_supgroup" name="cmb_supgroup">

                                                                                <option value="" default>-- Select --
                                                                                </option>
                                                                                <?php foreach ($data_sgroup as $t_data) { ?>
                                                                                    <option
                                                                ...
                                                                <!--                                                                    <div class="tab-pane" id="vertical-form">
                                                                                                                                            ...
                                                                                                                                            <div class="form-group col-sm-6">
                                                                                                                                             ...
                                                                                                                                             <div class="form-group col-sm-6">
                                                                                                                                                ...
                                                                                                                                                <div class="col-sm-8">
                                                                                                                                                    <input type="text" class="form-control" id="txt_BG_Allowance" name="txt_BG_Allowance" required="" placeholder="Ex: 5500">
                                                                                                                                                </div>
                                                                ...
                                                                <div class="tab-pane" id="vertical-form">
                                                                    ...
                                                                    <div class="form-group col-md-12">
                                                                        ...
                                                                        <div class="form-group col-sm-6">
                                                                            <label for="focusedinput"
                                                                                class="col-sm-4 control-label">NIC(user
                                                                                password) <span
                                                                                    style="color: red;">*</span></label>
                                                                            <div class="col-sm-8">
                                                                                <input type="text" required=""
