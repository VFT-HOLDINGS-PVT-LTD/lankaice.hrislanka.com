                                                        ...
                                                        <div class="tab-content">
                                                            <div class="tab-pane active" id="horizontal-form">
                                                                <form class="form-horizontal" id="frm_employee_update" name="frm_employee_update" action="<?php echo base_url(); ?>Employee_Management/Edit_Employees/update_emp" method="POST" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <input type="text" class="form-control" id="companyNo" name="companyNo" placeholder="Company No" required="" value="<?php echo $data_set[0]->Comp_Num ?>">
                                                                    ...
                                                                    <div class="form-group col-md-12">
                                                                        ...
                                                                        <div class="form-group col-sm-6">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <input type="text" class="form-control" value="<?php echo $data_set[0]->EPFNO ?>" id="txt_epf_no" name="txt_epf_no" placeholder="Ex: 1">
                                                                            </div>
                                                                    ...
                                                                    <div class="form-group col-md-12">
                                                                        ...
                                                                        <div class="form-group col-sm-6">
                                                                            <label for="focusedinput" class="col-sm-4 control-label">Preferred Name</label>
                                                                                <div class="col-sm-8">
                                                                                    <input type="text" class="form-control"  value="<?php echo $data_set[0]->pName ?>" id="pNameId" name="pName" placeholder="Preferred name">
                                                                                </div>
                                                                        </div>

                                                                        <div class="form-group col-sm-6">
                                                                            <label for="focusedinput" class="col-sm-4 control-label">Reporting Person</label>
                                                                            <div class="col-sm-8">
                                                                                <input type="text" class="form-control"  value="<?php echo $data_set[0]->rPerson ?>" id="rPersonId" name="rPerson" placeholder="Reporting Person">
                                                                            </div>
                                                                        ...
                                                                        <div class="form-group col-sm-6">
                                                                            <label for="focusedinput"
                                                                                class="col-sm-4 control-label">Category Code</label>
                                                                            <div class="col-sm-8">
                                                                            <select class="form-control"
                                                                                    id="cmb_emp_catCode" name="cmb_emp_catCode">
                                                                                    <?php 
                                                                                    if($data_set[0]->catCode == "EXE"){
                                                                                        $catCode = "Executive";
                                                                                    }elseif($data_set[0]->catCode == "STFF"){
                                                                                        $catCode = "Non-Executive";
                                                                                    }else{
                                                                                        $catCode = "Unknown";
                                                                                    }
                                                                                     ?>
                                                                                    <option value="<?php echo $data_set[0]->catCode ?>"><?php echo $catCode ?></option>
                                                                                    <option value="EXE">Executive</option>
                                                                                    <option value="STFF">Non-Executive</option>
                                                                        ...
                                                                        <div class="form-group col-sm-6">
                                                                        <label for="focusedinput"
                                                                            class="col-sm-4 control-label">Payment Type</label>
                                                                        <div class="col-sm-8">
                                                                        <select class="form-control"
                                                                                id="cmb_Payment_type" name="cmb_Payment_type">
                                                                                <option value="<?php echo $data_set[0]->payment_Type ?>"><?php echo $data_set[0]->payment_Type ?>
                                                                                </option>
                                                                    ...
                                                                    <div class="form-group col-md-12">
                                                                        ...
                                                                        <div class="form-group col-sm-6">
                                                                            <label for="focusedinput" class="col-sm-4 control-label">Employee Leave Group</label>
                                                                            <div class="col-sm-8">
                                                                        ...
                                                                        <div class="form-group col-sm-6">
                                                                            <label for="focusedinput" class="col-sm-4 control-label">Employee Super Group</label>
                                                                            <div class="col-sm-8">
                                                                                <select class="form-control" required="" id="cmb_supgroup" name="cmb_supgroup" >

                                                                                    <?php
                                                                                    foreach ($data_sgroup as $t_data) {
                                                                                        if ($t_data->id == $data_set[0]->id) {
                                                                                            echo "<option selected value='" . $t_data->id . "'>" . $t_data->super_gname . "</option>";
                                                                                        } else {
                                                                                            echo "<option value='" . $t_data->id . "'>" . $t_data->super_gname . "</option>";
                                                                                        }
                                                                                    }
                                                                                    ?>       
                                                                            ...
                                                                            <div class="form-group col-md-12">
                                                                                <!-- <div class="form-group col-sm-6">
                                                                                    <div class="form-group icheck-flat">
                                                                                        <label class="col-sm-2 control-label">Is Allow Mobile App Login</label>
                                                                                        <div class="col-sm-8 icheck-flat">

                                                                                            <label class="checkbox-inline icheck">
                                                                                                <?php 
                                                                                                if($data_set[0]->Is_mApp == 1){
                                                                                                    echo "Active";
                                                                                                }else{
                                                                                                    echo "Deactive";
                                                                                                }
                                                                                                ?>
                                                                                                <input type="checkbox" id="Is_Allow" name="Is_Allow" checked>
                                                                                            </label>
                                                                                        </div>
                                                                                    </div>
                                                                                </div> -->
                                                                                ...
                                                                                <div class="form-group col-sm-6 ">
                                                                            <label class="col-sm-4 control-label">Is Allow Mobile App Login</label>
                                                                            <div class="col-sm-8">
                                                                                <label class="radio-inline icheck">
                                                                                    <input type="radio" id="inlineradio1" required="" value="Active" <?php echo ($data_set[0]->Is_mApp == '1') ? 'checked' : '' ?> name="mobileApp_status" > Allowed 
                                                                                </label>
                                                                                <label class="radio-inline icheck">
                                                                                    <input type="radio" id="inlineradio2" value="Inactive" <?php echo ($data_set[0]->Is_mApp == '0') ? 'checked' : '' ?> name="mobileApp_status" > Unallowed
                                                                                </label>
