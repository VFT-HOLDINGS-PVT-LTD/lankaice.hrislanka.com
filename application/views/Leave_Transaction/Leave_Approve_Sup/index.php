...
//                            $('#cmb_cat2').remove();
        ...
        <script>
            ...
            $("#search").click(function () {
                ...
                $('#search_body').load("<?php echo base_url(); ?>Leave_Transaction/Leave_Approve_Sup/search_employee", {'txt_emp': $('#txt_emp').val(), 'txt_emp_name': $('#txt_emp_name').val(), 'cmb_desig': $('#cmb_desig').val(), 'cmb_dep': $('#cmb_dep').val(), 'txt_nic': $('#txt_nic').val(), 'cmb_status': $('#cmb_status').val(), 'cmb_gender': $('#cmb_gender').val(),'txt_from_date': $('#dpd1').val(),'txt_to_date': $('#dpd2').val(), 'cmb_branch': $('#cmb_branch').val()});
            });
