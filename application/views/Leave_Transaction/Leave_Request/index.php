                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="panel panel-info">
                                                            ...
                                                            <div class="panel-body">
                                                                <form class="form-horizontal" id="frm_leave_request" name="frm_leave_request" action="<?php echo base_url(); ?>Leave_Transaction/Leave_Request/insert_data" method="POST" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group col-md-12">
                                                                        ...
                                                                        <div class="form-group col-sm-6">
                                                                            <label for="focusedinput" class="col-sm-4 control-label date">Leave Attach</label>
                                                                            <div class="col-sm-8">
                                                                                <input type="file" class="form-control" id="leaveAttach" name="leaveAttach">
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group col-sm-6">
                                                                            <label for="focusedinput" class="col-sm-4 control-label date">Covering Person</label>
                                                                            <div class="col-sm-8">
                                                                                <input type="text" class="form-control" id="CoveringPerson" name="CoveringPerson">
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group col-sm-6">
                                                                            <label for="focusedinput" class="col-sm-4 control-label date">Reporting Person Name</label>
                                                                            <div class="col-sm-8">
                                                                                <input type="text" class="form-control" id="RPName" name="RPName" required="required">
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group col-sm-6">
                                                                            <label for="focusedinput" class="col-sm-4 control-label date">Leave Reason</label>
                                                                            <div class="col-sm-8">
                                                                                <textarea cols="10" rows="5" class="form-control" required="required" id="txt_reason" name="txt_reason"></textarea>
                                                            ...
                                                            <table  id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    foreach ($data_leave_sum as $data) {
                                                                        ...
                                                                        echo "<td width='100'>";
                                                                        echo "<a href='". base_url() ."assets/images/file/".$data->Attach."'>Download</a>";
                                                                        echo "</td>";
