    ...
    <div id="wrapper">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            foreach ($data_set_att as $data) {
                                                                                ...
                                                                                echo "<tr class='odd gradeX'>";
                                                                                    ...
                                                                                    echo "<td width='100'>";
                                                                                        echo "<button class='btn btn-success' data-toggle='modal' title='DELETE' onclick='ajaxStatusAprove($data->ID)'> Aprove </button> "; 
                                                                                        echo "<button class='btn btn-danger' data-toggle='modal' title='DELETE' onclick='ajaxStatus($data->ID)'> Reject </button>";
                                                                                    echo "</td>";
                                                                                echo "</tr>";
                                                                            }
                                                                            ?>
        ...
        <script>
            function ajaxStatus(id) {
                $.ajax({
                    url: baseurl + "index.php/Leave_Transaction/View_Short_Leave/ajax_Status/" + id,
                    type: "POST",
                    data: { id: id },
            ...
            function ajaxStatusAprove(id) {
                $.ajax({
                    url: baseurl + "index.php/Leave_Transaction/View_Short_Leave/ajax_Status_Aprove/" + id,
                    type: "POST",
                    data: { id: id },
                    success: function (response) {
                        alert("success");
