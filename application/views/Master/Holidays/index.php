                                            ...
                                            <div class="modal-body">
                                                <form class="form-horizontal" action="<?php echo base_url(); ?>Master/Holidays/edit" method="post">
                                                    ...
                                                    <div class="form-group col-sm-12">
                                                        <label for="focusedinput" class="col-sm-4 control-label">HOLIDAY</label>
                                                        <div class="col-sm-8">
                                                            <input value="<?php echo $data->Hdate; ?>" type="date" name="H_Date" id="H_Date"  class="form-control m-wrap span6"><br>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-sm-12">
                                                        <label for="focusedinput" class="col-sm-4 control-label">DESCRIPTION</label>
                                                        <div class="col-sm-8">
                                                            <input value="<?php echo $data->H_description; ?>" type="text" name="H_Desc" id="H_Desc"  class="form-control m-wrap span6"><br>
                                                        </div>
                                                    </div>
