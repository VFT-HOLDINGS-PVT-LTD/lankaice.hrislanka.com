...
<body class="infobar-offcanvas">
    ...
    <div id="wrapper">
                ...
                <div class="static-content">
                    <div class="page-content">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="<?php echo base_url(); ?>Master/SuperGroup/">SUPER GROUPS</a>
                            </li>
                        ...
                        <div class="page-tabs">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="active"><a data-toggle="tab" href="#tab1">SUPER GROUPS</a></li>
                                <li><a data-toggle="tab" href="#tab2">VIEW SUPER GROUPS</a></li>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="panel panel-info">
                                                        <div class="panel-heading">
                                                            <h2>ADD SUPER GROUPS</h2>
                                                        </div>
                                                        <div class="panel-body">
                                                            <form class="form-horizontal" id="frm_departmrnt"
                                                                name="frm_departmrnt"
                                                                action="<?php echo base_url(); ?>Master/SuperGroup/insertSuperGroup"
                                                                method="POST">
                                                                ...
                                                                <div class="form-group col-sm-12">
                                                                    <div class="col-sm-8">
                                                                        <img class="imagecss"
                                                                            src="<?php echo base_url(); ?>assets/images/SuperGroup.jpg"
                                                                ...
                                                                <div class="form-group col-sm-6">
                                                                    <label for="focusedinput"
                                                                        class="col-sm-4 control-label">Super Group
                                                                        Name</label>
                                                                    <div class="col-sm-8">
                                                                        <input type="text" class="form-control"
                                                                            required="required" id="txt_sgroup_name"
                                                                            name="txt_sgroup_name"
                                                                            placeholder="Ex: Super Group">
                                                                    </div>
                                                            ...
                                                            <table id="example"
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    foreach ($data_set as $data) {
                                                                        ...
                                                                        echo "<td width='100'>" . $data->super_gname . "</td>";
                                                                        ...
                                                                        // btn btn-primary
                                                                        echo "<td width='15'>";
                                                                        echo "<button class='get_data btn btn-green'  data-toggle='modal' data-target='#myModal' title='EDIT' data-id='$data->id' href='" . base_url() . "index.php/Master/SuperGroup/get_details" . $data->id . "'><i class='fa fa-edit'></i></button>";
                                                                        echo "</td>";
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal"
                                                action="<?php echo base_url(); ?>Master/SuperGroup/edit" method="post">
                                                <div class="form-group col-sm-12">
                                                    <label for="focusedinput" class="col-sm-4 control-label">ID</label>
                                                    <div class="col-sm-8">
                                                        <input value="<?php echo $data->id; ?>" type="text"
                                                ...
                                                <div class="form-group col-sm-12">
                                                    <label for="focusedinput" class="col-sm-4 control-label">Super
                                                        Group</label>
                                                    <div class="col-sm-8">
                                                        <input value="<?php echo $data->super_gname; ?>" type="text"
                                                            name="super_gname" id="super_gname"
        ...
        <!--Ajax-->
        <script src="<?php echo base_url(); ?>system_js/Master/SuperGroup.js"></script>
