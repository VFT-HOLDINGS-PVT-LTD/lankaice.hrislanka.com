                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="panel panel-info">
                                                            ...
                                                            <div class="panel-body">
                                                                <form class="form-horizontal" id="frm_variable_allowances" name="frm_variable_allowances" action="<?php echo base_url(); ?>Payroll/Allowance/insert_data" method="POST">
...
//                alert(branch_code);
                    ...
                    $.post('<?php echo base_url(); ?>index.php/Payroll/Allowance/dropdown/',
                            {
                                cmb_cat: branch_code
...
//                            $('#cmb_cat2').remove();
            ...
            <script>
                ...
                $("#search").click(function () {
                    ...
                    $('#search_body').load("<?php echo base_url(); ?>Pay/Allowance/getAllowances", {'txt_emp': $('#txt_emp').val(), 'txt_emp_name': $('#txt_emp_name').val(), 'cmb_desig': $('#cmb_desig').val(), 'cmb_dep': $('#cmb_dep').val(), 'cmb_month': $('#cmb_month').val(),'cmb_years': $('#cmb_years').val(),'cmb_allowances': $('#cmb_allowances').val()});
                });
