            ...
            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    foreach ($data_set as $data) {
                        ...
                        echo "<td width='15'>";
                        echo "<button class='get_data btn btn-green'  data-toggle='modal' data-target='#myModal' title='EDIT' data-id='$data->ID' href='" . base_url() . "index.php/Payroll/Allowance/get_details" . $data->ID . "'><i class='fa fa-edit'></i></button>";
                        echo "</td>";
