                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="panel panel-info">
                                                            ...
                                                            <div class="panel-body">
                                                                <form class="form-horizontal" id="frm_deduction_variable" name="frm_deduction_variable" action="<?php echo base_url(); ?>Payroll/Deduction/insert_data" method="POST">
                                                        ...
                                                        <form  class="form-horizontal" id="frm_in_out_rpt" name="frm_in_out_rpt" method="POST">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <div class="form-group col-sm-3">
                                                                    <label for="focusedinput" class="col-sm-4 control-label">Deduction Type</label>
                                                                    <div class="col-sm-8">
                                                                        <select class="form-control" required="" id="cmb_deductions" name="cmb_deductions" >
