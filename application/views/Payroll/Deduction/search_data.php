            ...
            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    foreach ($data_set as $data) {
                        ...
                        echo "<td width='15'>";
                        echo "<button class='get_data btn btn-green'  data-toggle='modal' data-target='#myModal' title='EDIT' data-id='$data->ID' href='" . base_url() . "index.php/Payroll/Deduction/get_details" . $data->ID . "'><i class='fa fa-edit'></i></button>";
                        echo "</td>";
...
<script type="text/javascript">
    ...
    $(".get_data").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "index.php/Payroll/Deduction/get_details",
            data: {'id': ID},
            dataType: "JSON",
        ...
        swal({title: "Are you sure?", text: "You will not be able to recover this data!", type: "warning", showCancelButton: true, confirmButtonColor: "#DD6B55", confirmButtonText: "Yes, Delete This!", cancelButtonText: "No, Cancel This!", closeOnConfirm: false, closeOnCancel: false},
                function (isConfirm) {
                    if (isConfirm) {
                        ...
                        $.ajax({
                            url: baseurl + "index.php/Payroll/Allowance/ajax_delete/" + id,
                            type: "POST",
                            dataType: "JSON",
                        ...
                        $(document).ready(function () {
                            setTimeout(function () {
                                window.location.replace(baseurl + "Payroll/Allowance/");
                            }, 1000);
                        });
