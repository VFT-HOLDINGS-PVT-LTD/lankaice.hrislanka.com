                    ...
                    <div class="static-content">
                        <div class="page-content">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><a href="index.html">PAYROLL PAYROLL</a></li>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="panel panel-primary">
                                                            <div class="panel-heading"><h2>PAYROLL PROCESS</h2></div>
                                                                ...
                                                                <form action="<?php echo base_url(); ?>index.php/Pay/Payroll_Process/emp_payroll_process" class="form-horizontal" id="frm_Payroll_Process" name="frm_Payroll_Process" method="POST">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-8 col-sm-offset-2">
                                                                            <button type="submit" id="submit" name="submit" class="btn-primary btn-lg fa fa-money">&nbsp;&nbsp;PAYROLL PROCESS</button>
