                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="panel panel-info">
                                                            ...
                                                            <div class="panel-body">
                                                                <form class="form-horizontal" id="frm_salary_advance" name="frm_salary_advance" action="<?php echo base_url(); ?>Payroll/Salary_Advance/insert_data" method="POST">
...
//                alert(branch_code);
                    ...
                    $.post('<?php echo base_url(); ?>index.php/Payroll/Deduction/dropdown/',
                            {
                                cmb_cat: branch_code
