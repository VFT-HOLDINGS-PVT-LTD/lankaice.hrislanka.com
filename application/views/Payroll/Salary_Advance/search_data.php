            ...
            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    foreach ($data_set as $data) {
                        ...
                        echo "<td width='15'>";
                        echo "<a class='get_data btn btn-primary' href='" . base_url() . "Payroll/Salary_Advance/approve/" . $data->id . "'>APPROVE<i class=''></i> </a>";
                        echo "</td>";
                        
                        echo "<td width='15'>";
                        echo "<a class='get_data btn btn-danger' href='" . base_url() . "Payroll/Salary_Advance/reject/" . $data->id . "'>REJECT<i class=''></i> </a>";
                        echo "</td>";
