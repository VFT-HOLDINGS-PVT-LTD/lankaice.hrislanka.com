                    ...
                    <div class="static-content">
                        <div class="page-content">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><a href="index.html">PAYROLL DATA PUSH</a></li>
                            ...
                            <div class="page-tabs">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="active"><a data-toggle="tab" href="#tab1">PAYROLL DATA PUSH</a></li>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="panel panel-primary">
                                                            <div class="panel-heading"><h2>PAYROLL DATA PUSH</h2></div>
                                                            <div class="panel-body">
                                                                <form action="<?php echo base_url(); ?>Payroll_Data_Push/Payroll_Data_Push/pushed_payroll_data" class="form-horizontal" id="frm_Payroll_Process" name="frm_Payroll_Process" method="POST">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-8 col-sm-offset-2">
                                                                            <button type="submit" id="submit" name="submit" class="btn-primary btn-lg fa fa-money">&nbsp;&nbsp;PAYROLL DATA PUSH</button>
