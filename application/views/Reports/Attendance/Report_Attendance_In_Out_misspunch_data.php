                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <form action="<?php echo base_url(); ?>Reports/Attendance/Report_Attendance_In_Out_misspunch/Attendance_Report_By_Cat" class="form-horizontal" id="frm_in_out_rpt" name="frm_in_out_rpt" method="POST">
