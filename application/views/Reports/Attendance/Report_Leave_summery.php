                                                ...
                                                <div class="col-md-12">
                                                    <div class="panel panel-primary">
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <form
                                                                action="<?php echo base_url(); ?>Reports/Attendance/Report_Leave_summery/Leave_Summery_Report_By_Cat"
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <input type="submit" id="search" name="search"
                                                                        ...
                                                                        value="&nbsp;&nbsp;VIEW&nbsp; REPORT">
                                                                        <input type="submit" id="search1" name="search1"
                                                                        formtarget="_new"
                                                                        class="btn-green btn fa fa-check"
    ...
    <script>
        $(document).ready(function () {
            $("#search1").click(function (e) {
                ...
                $.ajax({
                    url: "<?php echo base_url(); ?>Reports/Attendance/Report_Leave_summery/Leave_Summery_Report_By_Cat_excel",
                    type: "POST",
                    data: formData,
                    dataType: "json",
                    success: function (response) {
                        ...
                        newWindow.document.addEventListener('DOMContentLoaded', function () {
                            var table = newWindow.document.getElementById('leave_summary_table');
