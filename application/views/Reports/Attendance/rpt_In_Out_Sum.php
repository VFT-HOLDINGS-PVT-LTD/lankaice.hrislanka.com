            ...
            <table cellpadding="3">
                <thead style="border-bottom: #000 solid 1px;">
                    <tr style="border-bottom: 1px solid black;"> 
                        ...
                        <th style="font-size:11px;border-bottom: 1px solid black;">BREAK IN</th>
                        <th style="font-size:11px;border-bottom: 1px solid black;">BREAK OUT</th>
...
if($data->Lv_T_ID != 0){
    ...
    $html .= ' <tr>
                        ...
                        <td style="font-size:10px;">' . $data->BreackInTime1 . '</td>
                        <td style="font-size:10px;">' . $data->BreackOutTime1 . '</td>
