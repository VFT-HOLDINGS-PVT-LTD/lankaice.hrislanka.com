            ...
            <table cellpadding="3">
                <thead style="border-bottom: #000 solid 1px;">
                    <tr style="border-bottom: 1px solid black;"> 
                        ...
                        <th style="font-size:11px;border-bottom: 1px solid black;  width:120px;">LOCATION</th>
                        <th style="font-size:11px;border-bottom: 1px solid black; width:70px;">FROM DATE</th>
                        ...
                        <th style="font-size:11px;border-bottom: 1px solid black; width:60;">STATUS</th>         
                    </tr>
                </thead>
             <tbody>';
...
foreach ($data_set as $data) {
    ...
    $html .= ' <tr>
                        ...
                        <td style="font-size:10px;  width:120px;">' . $data->B_name . '</td>
                        <td style="font-size:10px; width:70px;">' . $data->FDate . '</td> 
