            ...
            <table cellpadding="3">
                <thead style="border-bottom: #000 solid 1px;">
                    <tr style="border-bottom: 1px solid black;"> 
                        ...
                        <th style="font-size:11px;border-bottom: 1px solid black;">REGION</th>
...
foreach ($data_set as $data) {
    ...
    if ($emtnocheck != $data->EmpNo) {
        ...
        <td style="font-size:10px;border-top: 1px solid black;">' . $data->leave_name . '</td>
        <td style="font-size:10px;border-top: 1px solid black;">' . $data->B_name . '</td> 
        <td style="font-size:10px;border-top: 1px solid black;">' . $data->Leave_Date . '</td>    
        <td style="font-size:10px;border-top: 1px solid black;">' . $data->Leave_Count . '</td>
        <td style="font-size:10px;border-top: 1px solid black;">' . $data->APP_Emp_Full_Name . '</td>
        <td style="font-size:10px;border-top: 1px solid black;">' . $data->Reason . '</td>
        ...
        <td style="font-size:10px;">' . $data->B_name . '</td> 
