...
$pdf->SetTitle('SHORT LEAVE REPORT' . $f_date . ' to ' . $t_date . '.pdf');
...
$html = '
        <div style="margin-left:200px; text-align:center; font-size:13px;">SHORT LEAVE REPORT</div>
            ...
            <table cellpadding="3">
                <thead style="border-bottom: #000 solid 1px;">
                    <tr style="border-bottom: 1px solid black;"> 
                        ...
                        <th style="font-size:11px;border-bottom: 1px solid black;">DAYS</th>
...
foreach ($data_set as $data) {
    ...
    $html .= ' <tr>
                        ...
                        <td style="font-size:10px;">' . $data->from_time . '</td> 
                        <td style="font-size:10px;">' . $data->to_time . '</td> 
                    </tr>'
