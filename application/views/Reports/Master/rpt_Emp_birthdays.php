            ...
            <table cellpadding="5" font size="6">
                <thead style="border-bottom: #000 solid 1px;">
                    <tr style="border-bottom: 1px solid black;"> 
                        ...
                        <th style="font-size:16px;border-bottom: 1px solid black; width:250px;">EMPLOYEE NAME</th>  
                        <th style="font-size:16px;border-bottom: 1px solid black; width:150px;">REGION</th>              
                        <th style="font-size:16px;border-bottom: 1px solid black; width:100px;">DOB</th>   
                    </tr>
                </thead>
             <tbody>';
...
foreach ($data_set as $data) {
 ...
 <td  style="font-size:13px; width:250px;">' . $data->Emp_Full_Name . '</td>
  <td  style="font-size:13px; width:150px;">' . $data->B_name . '</td>
 <td  style="font-size:13px; width:100px;">' . $data->DOB . '</td>
