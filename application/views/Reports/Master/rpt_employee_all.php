            ...
            <table cellpadding="3">
                <thead style="border-bottom: #000 solid 1px;">
                    <tr style="border-bottom: 1px solid black; font-weight:bold"> 
                        ...
                        <th style="font-size:11px;border-bottom: 1px solid black;width:170px;">ADDRESS</th>
                        <th style="font-size:11px;border-bottom: 1px solid black; width:65px;">MOBILE</th>
                        <th style="font-size:11px;border-bottom: 1px solid black; width:55px;">GENDER</th>
                        <th style="font-size:11px;border-bottom: 1px solid black; width:70px;">APOINT DATE</th>
                        <th style="font-size:11px;border-bottom: 1px solid black;width:80px;">REGION</th>
...
foreach ($data_set as $data) {
    ...
    $html .= ' <tr>
                    ...
                    <td style="font-size:10px;width:170px;">' . $data->Address . '</td>
                    <td style="font-size:10px;width:65px;">' . $data->Tel_mobile . '</td>
                    <td style="font-size:10px; width:55px;">' . $data->Gender . '</td>
                        <td style="font-size:10px; width:70px;">' . $data->ApointDate . '</td>
                        <td style="font-size:10px;width:80px;">' . $data->B_name . '</td>
