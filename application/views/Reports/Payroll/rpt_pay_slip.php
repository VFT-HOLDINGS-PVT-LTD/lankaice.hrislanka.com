...
$html = '
            ...
            <h6 style="margin-left:200px;margin-top:-90px; text-align:center; ">DEDIGAMA GROUP (PVT) LTD</h6>
           ...
           <hr>
             ...
             <br>
                ...
                <tr>
                    <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Budgetary Allowances 1</td>
                    <td ></td>
                    <td align="right">' . number_format($data_set[0]->BD_Al1, 2, '.', ',') . '</td>
                </tr>
                <tr>
                    <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Budgetary Allowances 2</td>
                    <td > </td>
                    <td align="right">' . number_format($data_set[0]->BD_Al2, 2, '.', ',') . '</td>
                </tr>
                <tr>
