                ...
                <thead style="border-bottom: #000 solid 1px;">
                    <tr style="border-bottom: 1px solid black; font-weight:bold"> 
                        ...
                        <th style="font-size:11px;border-bottom: 1px solid black;width:60px;">NOPAY AMOUNT</th>
                         <th style="font-size:11px;border-bottom: 1px solid black;width:55px;">GROSS</th>
                        ...
                        <th style="font-size:11px;border-bottom: 1px solid black; text-align:right;width:70px;">TOTAL SALARY</th>
...
foreach ($data_set as $data) {
    ...
    $html .= ' <tr>
                        ...
                        <td style="font-size:10px;width:60px;">' .number_format($data->Basic_sal, 2, '.', ',')  . '</td>
                            <td style="font-size:10px;width:60px;">' . $data->Fixed_Allowance . '</td>
                                <td style="font-size:10px;width:60px;">' . $data->No_Pay_days . '</td>
                                    <td style="font-size:10px;width:60px;">' . $data->no_pay_deduction . '</td>
                                        <td style="font-size:10px;width:55px;">' . number_format($data->Basic_sal + $data->Incentive, 2, '.', ',') . '</td>
                        ...
                        <td style="font-size:10px;width:70px; text-align:right;font-weight:bold">' . number_format($data->Net_salary, 2, '.', ',') . '</td>
