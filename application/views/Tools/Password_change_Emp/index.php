                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="panel panel-info">
                                                            ...
                                                            <div class="panel-body">
                                                                <form class="form-horizontal" id="frm_password_change" name="frm_password_change" action="<?php echo base_url(); ?>Employee_Management/Edit_Employees/Change" method="POST">
                                                                    ...
                                                                    <input type="password" class="hidden form-control" id="txt_emp" name="txt_emp" value="<?php echo $data_set; ?>" placeholder="Current Password">
