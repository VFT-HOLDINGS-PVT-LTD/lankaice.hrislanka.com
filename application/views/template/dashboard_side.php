...
$paydata = $this->Db_model->getfilteredData("select * from tbl_empmaster where Emp_Full_Name = '".$User_Name."' ");
...
<div style="border-radius: 20px; " class="static-sidebar-wrapper sidebar-default">
    <div class="static-sidebar">
        <div class="sidebar">
            <div class="" id="widget-welcomebox" style="background-color: #479cba; color: white">
            ...
            <div class="widget stay-on-collapse" id="widget-sidebar">
                <nav role="navigation" class="widget-body">
                    <ul class="acc-menu">
                        ...
                        <?php if ($currentUser[0]->master_data == 1): ?>
                            ...
                            <?php if ($currentUser[0]->master_data == 1): ?>
                                ...
                                <?php endif; ?>
                                 ...
                                 <?php if ($currentUser[0]->employee_groups == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Master/SuperGroup/">SUPER GROUPS</a></li>
                                <?php endif; ?>
                        ...
                        <?php if ($currentUser[0]->Attendance == 1): ?>
                            ...
                            <ul class="acc-menu">
                                ...
                                <?php if ($currentUser[0]->manual_att_request == 1): ?>
                                     <li><a href="<?php echo base_url(); ?>Attendance/Attendance_Manual_Entry_Request">ATTENDANCE REQUEST</a></li> 
                                <?php endif; ?>
                                ...
                                <?php if ($currentUser[0]->Is_manual_Admin == 1): ?>
                                    <!-- <li><a href="<?php echo base_url(); ?>Attendance/Attendance_Manual_Entry_ADMIN">MANUAL ATTENDANCE ADJUST</a></li> -->
                                <?php endif; ?>  
                        ...
                        <?php if ($currentUser[0]->Leave_Transaction == 1): ?>
                            ...
                            <ul class="acc-menu">
                                ...
                                <?php if ($currentUser[0]->leave_entry == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Leave_Transaction/Leave_Entry">LEAVE ENTRY(DIRECT)</a></li>
                                <?php endif; ?>
                                ...
                                <?php if ($currentUser[0]->leave_adj == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Leave_Transaction/Leave_Approve_Adj">LEAVE ADJUSTMENT</a></li>
                                <?php endif; ?>
                        ...
                        <!--<?php if ($paydata[0]->Enroll_No == 1539 || $paydata[0]->user_p_id == 1): ?>-->
                        <!--    <li><a href="javascript:;"><i class="fa fa-money"></i><span>PAYROLL DATA PUSH</span></a>-->
                        <!--    <?php endif; ?>-->

                        <!--    <ul class="acc-menu">-->
                        <!--        <?php if ($paydata[0]->Enroll_No == 1539 || $paydata[0]->user_p_id == 1): ?>-->
                        <!--            <li><a href="<?php echo base_url(); ?>Payroll_Data_Push/Payroll_Data_Push">PAYROLL DATA APPROVE</a></li>-->
                        <!--        <?php endif; ?>-->
                        <!--       <?php if ($currentUser[0]->company_profile == 1): ?>-->
                        <!--            <li><a href="<?php echo base_url(); ?>Payroll_Data_Push/Payroll_Data_Push">PAYROLL DATA SUP APPROVE</a></li>-->
                        <!--        <?php endif; ?>-->
                        <!--    </ul>-->
                        ...
                        <?php if ($currentUser[0]->Attendance_Report == 1): ?>
                            ...
                            <?php if ($currentUser[0]->Attendance_Report == 1): ?>
                                ...
                                <?php if ($currentUser[0]->leave_report == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Reports/Attendance/Short_Leave">SHORT LEAVE REPORT</a></li>
                                <?php endif; ?>
