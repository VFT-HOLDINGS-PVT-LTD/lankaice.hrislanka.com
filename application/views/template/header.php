...
<header
    style="border-bottom-left-radius: 20px;border-bottom-right-radius: 20px; margin-bottom: 100px; background-color: #ffffff"
    id="topnav" class="navbar navbar-midnightblue navbar-fixed-top clearfix" role="banner">
    ...
    <img style="width: 50px;" src="<?php echo base_url(); ?>assets/images/company/VTF-Logo.png"><a
        style="font-size: 20px; margin-top: 150px; color: #000; " href="<?php echo base_url(); ?>Dashboard">VFT
        Attendance System </a>

    <a style="font-size: 10px;" href="#"><?php
    if ($data['autorun_settings'][0]->status_flag == 1) {
        ?>
            <div style="position: absolute; width: 100%;" id="attendance-message">
                <div style="display: inline; right: 0; position: absolute; border-radius: 20px; margin-top: 10px;"
                    class="alert alert-warning" role="alert">
                    <span style="font-size: 12px;">At this time, the attendance process is carried out in the VFT Attendance System</span>
                </div>
            </div>

            <?php
    } elseif ($data['autorun_settings3'][0]->status_flag == 1) {
        ?>
            <div style="position: absolute; width: 100%;" id="attendance-message">
                <div style="display: inline; right: 0; position: absolute; border-radius: 20px; margin-top: 10px;"
                    class="alert alert-warning" role="alert">
                    <span style="font-size: 12px;">At this time, the attendance initialize is carried out in the VFT
                        Attendance System</span>
                </div>
            </div>
            <?php
    } elseif ($data['autorun_settings2'][0]->status_flag == 1) {
        ?>
            <div style="position: absolute; width: 100%;" id="attendance-message">
                <div style="display: inline; right: 0; position: absolute; border-radius: 20px; margin-top: 10px;"
                    class="alert alert-warning" role="alert">
                    <span style="font-size: 12px;">At this time, the shift allocation is carried out in the VFT Attendance
                        System</span>
                </div>
            </div>
            <?php
    ...
    <ul class="nav navbar-nav toolbar pull-right">
        ...
        <li class="toolbar-icon-bg hidden-xs" id="trigger-fullscreen">
            <a href="#" class="toggle-fullscreen"><span class="icon-bg"><i
                        class="fa fa-fw fa-arrows-alt"></i></span></i></a>
        </li>
        ...
        <?php if ($currentUser[0]->header_lv_nt == 1): ?>
            ...
            <li class="dropdown toolbar-icon-bg">
                <a href="#" class="hasnotifications dropdown-toggle" data-toggle='dropdown'><span class="icon-bg"><i
                            class="fa fa-fw fa-bell"></i></span><span class="badge badge-info"><?php echo $Not ?></span></a>
                    ...
                    <div class="scrollthis scroll-pane">
                        <ul class="scroll-content">
                            ...
                            <?php foreach ($Notifications as $t_data) { ?>
                                ...
                                <li class="">
                                    <a href="<?php echo base_url(); ?>Leave_Transaction/Leave_Approve/noti/<?php echo $t_data->ID; ?>"
        ...
        <li class="dropdown toolbar-icon-bg hidden-xs">
            <a href="#" class="hasnotifications dropdown-toggle" data-toggle='dropdown'><span class="icon-bg"><i
                        class="fa fa-fw fa-envelope"></i></span><span
                    class="badge badge-grape"><?php echo $Messagecount[0]->Count; ?></span></a>
            <div class="dropdown-menu dropdown-alternate messages arrow">
                            ...
                            <li class="">
                                <a href="<?php echo base_url(); ?>Message/Receive_Message">
                                    <img class="msg-avatar"
                                        src="<?php echo base_url(); ?>assets/images/Employees/<?php echo $m_data->Image; ?>"
                                        alt="avatar" />
                ...
                <div class="dd-footer"><a href="<?php echo base_url(); ?>Message/Receive_Message">View all messages</a>
                </div>
            </div>
        </li>
        ...
        <li class="dropdown toolbar-icon-bg">
            ...
            <ul class="dropdown-menu userinfo arrow">
                <li><a href="<?php echo base_url(); ?>Tools/Profile_Manage"><span class="pull-left">My Profile</span>
                        <span><i class="pull-right fa fa-user"></i></span></a></li>
                <li><a href="<?php echo base_url(); ?>Tools/Password_change"><span class="pull-left">Change
                            Password</span> <i class="pull-right fa fa-key"></i></a></li>

                <li><a href="<?php echo base_url() . "index.php/login/logout/" ?>"><span class="pull-left">Sign
